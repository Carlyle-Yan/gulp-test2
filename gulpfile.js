...
/**
 * 组件安装
 * npm install gulp gulp-notify gulp-htmlmin gulp-livereload gulp-sass gulp-rename gulp-autoprefixer gulp-cssnano jshint gulp-jshint gulp-uglify gulp-concat gulp-imagemin del --save-dev
 *
 * 参考：
...
/**
* 压缩页面javascript、css，去除页面空格、注释，删除多余属性等
**/
gulp.task('html', function () {
    var options = {
...
gulp.task('default', ['clean'], function () {
    gulp.start('html', 'assets', 'css', 'images', 'js','js-concat');
});
